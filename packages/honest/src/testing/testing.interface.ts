...
import type { DiContainer, HonestOptions, ModuleOptions } from '../interfaces';
 ...
 */
export interface CreateControllerTestApplicationOptions
  extends Omit<TestModuleOptions, 'controllers'> {
  /**
...
/**
 * Injectable-only or Service-only test harness around the DI container.
 */
