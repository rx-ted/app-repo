...
export class MetadataRepository implements IMetadataRepository {
  ...
  private readonly controllerComponents = new Map<
    MetadataComponentType,
  ...
  private captureController(controller: Constructor): void {
    ...
    const routes = (MetadataRegistry.getRoutes(controller) || []).map((route) =>
      this.cloneRouteDefinition(route),
    );
    ...
    this.contextIndices.set(
      controller,
      new Map(MetadataRegistry.getContextIndices(controller) || new Map()),
    );
