...
import type { RouteRegistry } from '../registries/route.registry';
...
export class RouteManager {
  ...
  constructor(
    ...
    this.globalPrefix =
      options.prefix !== undefined ? this.normalizePath(options.prefix) : undefined;
  ...
  async registerController(controllerClass: Constructor): Promise<void> {
    ...
    for (const route of routes) {
      ...
      const effectiveVersion =
        routeVersion !== undefined ? routeVersion : effectiveControllerVersion;
  ...
  private registerRoute(
    ...
    const fullPath = this.buildRoutePath(
      prefixSegment,
      versionSegment,
      controllerSegment,
      methodSegment,
    ...
    const handlerMiddleware = this.componentManager.getHandlerMiddleware(
      controllerClass,
      handlerName,
    );
