...
> **Note:** This is a local copy used within the `@rx-ted/app` monorepo.
> The upstream source is [honestjs/honest](https://github.com/honestjs/honest).
> This copy includes local modifications for plugin integration.
