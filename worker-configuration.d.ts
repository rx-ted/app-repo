/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 16a0b6dee3b659b059b315c6579d13ff)
// Runtime types generated with workerd@1.20260504.1 2026-05-11 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./apps/platform-api/runtime/cloudflare");
	...
	interface Env {
		...
		DB: D1Database;
		DEBUG: "false";
		MAIL_BREVO_FROM_EMAIL: "noreply@19981204.xyz";
		MAIL_BREVO_FROM_NAME: "noreply";
		DB_HOST: string;
		DB_PORT: string;
		DB_USER: string;
		DB_PASSWORD: string;
		...
		MAIL_RESEND_FROM_EMAIL: string;
		MAIL_RESEND_FROM_NAME: string;
		MAIL_SMTP_HOST: string;
		MAIL_SMTP_PORT: string;
		MAIL_SMTP_USER: string;
		MAIL_SMTP_PASS: string;
		MAIL_SMTP_FROM_EMAIL: string;
		MAIL_SMTP_FROM_NAME: string;
		GITHUB_REPO_OWNER: string;
		GITHUB_REPO_NAME: string;
		GISCUS_REPO_ID: string;
		GISCUS_CATEGORY: string;
		GISCUS_CATEGORY_ID: string;
		ORAMA_PROJECT_ID: string;
		ORAMA_DATA_SOURCE_ID: string;
		ORAMA_WRITE_API_KEY: string;
		ORAMA_READ_API_KEY: string;
		...
		PICX_API_KEY: string;
		COUNTER_DO: DurableObjectNamespace<import("./apps/platform-api/runtime/cloudflare").CounterDO>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEBUG" | "MAIL_BREVO_FROM_EMAIL" | "MAIL_BREVO_FROM_NAME" | "DB_HOST" | "DB_PORT" | "DB_USER" | "DB_PASSWORD" | "DB_DATABASE" | "DB_SSL" | "REDIS_USERNAME" | "REDIS_HOST" | "REDIS_PORT" | "REDIS_PASSWORD" | "JWT_SECRET" | "FRONTEND_DOMAIN" | "GITHUB_CLIENT_ID" | "GITHUB_SECRET" | "MAIL_RESEND_API_KEY" | "MAIL_RESEND_FROM_EMAIL" | "MAIL_RESEND_FROM_NAME" | "MAIL_SMTP_HOST" | "MAIL_SMTP_PORT" | "MAIL_SMTP_USER" | "MAIL_SMTP_PASS" | "MAIL_SMTP_FROM_EMAIL" | "MAIL_SMTP_FROM_NAME" | "GITHUB_REPO_OWNER" | "GITHUB_REPO_NAME" | "GISCUS_REPO_ID" | "GISCUS_CATEGORY" | "GISCUS_CATEGORY_ID" | "ORAMA_PROJECT_ID" | "ORAMA_DATA_SOURCE_ID" | "ORAMA_WRITE_API_KEY" | "ORAMA_READ_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "ADMIN_USERS" | "RATE_LIMIT_ENABLED" | "PICX_API_KEY">> {}
}
