...
export function rehypeCaptureCodeMeta() {
  return (tree: any) => {
    const queue: Array<{ parent: any; index: number; wrapper: any }> = [];
...
export function rehypeCodeGroup() {
  return (tree: any) => {
    const queue: Array<{ parent: any; index: number; group: any }> = [];
...
export function rehypeRestoreCodeBlocks() {
  return (tree: any) => {
    const queue: Array<{ parent: any; index: number; figure: any }> = [];
